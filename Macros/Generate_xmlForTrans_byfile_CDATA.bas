      ...
      For i = 1 To trnlst.StringCount
        ...
        If s1 <> "" Then
          ...
          trnlst.String(i).State(pslStateHidden)=False Then
              ...
              'fix CTADA issue, comment CTADA tags before export
...
Sub CreateHead()
  ...
  oupath=filePath+prj.Languages.Item(kl).LangCode+"\"+prj.Name +"_"+ CStr(trnlst.ListID)+"_"+ trnlst.Title+"."+fsys.GetExtensionName(trnlst.TargetFile)  +"_"+CStr(filenum)+"_"+prj.Languages.Item(kl).LangCode+".xml"
