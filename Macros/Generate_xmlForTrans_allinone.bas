...
'  If fsys.FileExists (filePath)=True Then
'     xmldoc.load (filePath)
'  Else
     xmldoc.loadXML "<?xml version=""1.0"" encoding=""utf-16""?><dictionary></dictionary>"
'  End If
 ...
 ' For Each prj In PSL.Projects
  ...
  Set nodelist=xmldoc.getElementsByTagName("file")

  If nodelist.length <>0 Then  xmldoc.Save filePath+prj.Name + "_"+prj.Languages.Item(kl).LangCode+".xml"
