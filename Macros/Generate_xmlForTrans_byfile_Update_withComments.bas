...
'#Reference {06290C00-48AA-11D2-8432-006008C3FBFC}#1.0#0#C:\Windows\system32\scrobj.dll#Microsoft Scriptlet Library
'#Reference {420B2830-E718-11CF-893D-00A0C9054228}#1.0#0#C:\Windows\system32\scrrun.dll#Microsoft Scripting Runtime
'#Reference {0E59F1D2-1FBE-11D0-8FF2-00A0D10038BC}#1.0#0#C:\Windows\system32\msscript.ocx#Microsoft Script Control 1.0
Option Explicit
...
Dim xmldoc As New DOMDocument40
  ...
  Dim dumy As Long
  Dim rootnode As IXMLDOMNode, snode As IXMLDOMNode, filenamenode As IXMLDOMNode,tnode As IXMLDOMNode,langnode As IXMLDOMNode,txtnode As IXMLDOMNode, commentnode As IXMLDOMNode
      ...
      For i = 1 To trnlst.StringCount
        ...
        If s1 <> "" Then
          ...
          trnlst.String(i).State(pslStateHidden)=False Then
              ...
              commentnode.Text = trnlst.String(i).Comment
              ...
              temppnode.appendChild txtnode.cloneNode (True )
              temppnode.appendChild commentnode
			  temppnode.appendChild txtnode.cloneNode (True )
