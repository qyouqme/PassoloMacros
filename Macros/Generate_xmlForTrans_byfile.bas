...
Sub CreateHead()
  ...
  oupath=filePath+prj.Languages.Item(kl).LangCode+"\"+prj.Name +"_"+ CStr(trnlst.ListID)+"_"+ fsys.GetFileName (trnlst.SourceList.SourceFile) +"_"+CStr(filenum)+"_"+prj.Languages.Item(kl).LangCode+".xml"
