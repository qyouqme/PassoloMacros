...
Private Function MainDlgFunc%(DlgItem$, Action%, SuppValue&)
	...
	If OSLanguage = "0404" Then
		Msg01 = "岿粇"
		Msg02 = "叫匡璶陆亩﹃"
		Msg03 = "礚猭纗叫浪琩琌Τ糶竚舦:" & vbCrLf & vbCrLf
		Msg04 = "絋粄"
		Msg05 = "眤╰参ぶ Microsoft.XMLHTTP ン礚猭膥尿磅︽"
	...
	Else
		Msg01 = "错误"
		Msg02 = "请选择要翻译的字串！"
		Msg03 = "无法保存！请检查是否有写入下列位置的权限:" & vbCrLf & vbCrLf
		Msg04 = "确认"
		Msg05 = "您的系统缺少 Microsoft.XMLHTTP 对象，无法继续运行！"
...
Sub Main
	...
	If OSLanguage = "0404" Then
		Msg00 = "舦┮Τ(C) 2010 by wanfu  セ: " & Version
		Msg01 = "硈絬陆亩エ栋"
		Msg02 = "セ祘Α硄筁┮匡硈絬陆亩ま篮㎝ㄤ匡兜笆陆亩睲虫い﹃" & _
				"眤璹陆亩ま篮のㄤ把计"
		...
		Msg77 = ""
	Else
		Msg00 = "版权所有(C) 2010 by wanfu  版本: " & Version
		Msg01 = "在线翻译宏"
		Msg02 = "本程序通过所选的在线翻译引擎和其他选项，自动翻译列表中的字串。" & _
				"您可以自定义翻译引擎及其参数。"
		...
		Msg27 = "去除快捷键(&K)"
		Msg28 = "去除加速器(&J)"
		Msg29 = "替换特定字符并在翻译后还原(&P)"
		Msg30 = "分行翻译(&F)"
		Msg31 = "纠正快捷键、终止符、加速器(&K)"
		Msg32 = "替换特定字符(&R)"
	...
	Begin Dialog UserDialog 620,462,Msg01,.MainDlgFunc ' %GRID:10,7,1,1
		...
		OKButton 420,434,90,21,.OKButton '5 继续
...
Function Settings(EngineID As Integer,CheckID As Integer) As Integer
	...
	If OSLanguage = "0404" Then
		...
		Msg33 = "陆亩玡璶砆蠢传じ (ノ | だ筳蠢传玡じ) (硆腹だ筳):"
	...
	Else
		...
		Msg33 = "翻译前要被替换的字符 (用 | 分隔替换前后的字符) (半角逗号分隔):"
...
Private Function SetFunc%(DlgItem$, Action%, SuppValue&)
	...
	If OSLanguage = "0404" Then
		...
		Msg12 = "狦琘ㄇ把计盢ㄏ祘Α磅︽挡狦ぃタ絋" & vbCrLf & _
				"眤絋龟稱璶硂妓暗盾"
		Msg13 = "砞﹚ず甧竒跑琌⊿Τ纗" & vbCrLf & "琌惠璶纗"
		Msg14 = "纗摸竒跑琌⊿Τ纗" & vbCrLf & "琌惠璶纗"
		...
		Item5 = "˙磅︽(箇砞) {True}"
		Item6 = "钵˙磅︽ {False}"
		Item7 = "礚才腹俱计皚 {responseBody}"
		Item8 = "ADO Stream ン {responseStream}"
		Item9 = "﹃ {responseText}"
		Item10 = "XML Α戈 {responseXML}"
	Else
		Msg01 = "错误"
		Msg02 = "默认值"
		Msg03 = "原值"
		...
		Msg12 = "如果某些参数为空，将使程序运行结果不正确。" & vbCrLf & _
				"您确实想要这样做吗？"
		Msg13 = "配置内容已经更改但是没有保存！" & vbCrLf & "是否需要保存？"
		Msg14 = "保存类型已经更改但是没有保存！" & vbCrLf & "是否需要保存？"
		...
		Item5 = "同步执行(默认) {True}"
		Item6 = "异步执行 {False}"
		Item7 = "无符号整数数组 {responseBody}"
		Item8 = "ADO Stream 对象 {responseStream}"
		Item9 = "字符串 {responseText}"
		Item10 = "XML 格式数据 {responseXML}"
	End If
...
Function EditLang(DataArr() As String,LangName As String,SrcCode As String,TarnCode As String) As String
	...
	If OSLanguage = "0404" Then
		...
		Msg15 = "陆亩ま篮粂ē絏琌璶穝块"
		Msg16 = "狦絋龟惠璶╰参盢笆砞﹚Null"
	Else
		Msg01 = "添加"
		Msg02 = "编辑"
		Msg04 = "语言名称:"
		...
		Msg15 = "翻译引擎语言代码为空！是否要重新输入？"
		Msg16 = "如果确实需要空值，系统将自动置为“Null”值。"
	End If
...
Sub TranTest(EngineID As Integer,HeaderList() As String,fType As Integer)
	...
	If OSLanguage = "0404" Then
		Msg01 = "陆亩ま篮代刚"
		Msg02 = "陆亩睲虫㎝ㄓ方粂ē穦沮盡瞷Τ粂ē笆絋﹚璶糤兜ヘ叫穝糤癸莱粂ē"
		Msg03 = "陆亩ま篮:"
		Msg04 = "ㄓ方粂ē:"
		Msg05 = "ヘ夹粂ē:"
		Msg06 = "陆亩睲虫:"
		Msg07 = "弄︽计:"
		Msg08 = "陆亩ず甧(笆眖匡拒睲虫い弄┪も笆块):"
		Msg09 = "陆亩挡狦(代刚秙块挡狦):"
		Msg10 = "ㄓ方﹃"
		Msg11 = "陆亩﹃"
		Msg12 = "陆亩ゅ"
		Msg13 = "场ゅ"
	...
	Else
		Msg01 = "翻译引擎测试"
		Msg02 = "翻译列表和来源语言会根据方案现有的语言自动确定。要增加项目请添加相应的语言。"
		Msg03 = "翻译引擎:"
		Msg04 = "来源语言:"
		Msg05 = "目标语言:"
		Msg06 = "翻译列表:"
		Msg07 = "读入行数:"
		Msg08 = "翻译内容(自动从选定列表中读入或手动输入):"
		Msg09 = "翻译结果(按测试按钮后在此输出结果):"
		Msg10 = "来源字串"
		Msg11 = "翻译字串"
		Msg12 = "翻译文本"
		Msg13 = "全部文本"
...
Private Function TranTestFunc(DlgItem$, Action%, SuppValue&) As Boolean
	...
	If OSLanguage = "0404" Then
		...
		Msg05 = "タ陆亩惠璶碭だ牧叫祔..."
		Msg06 = "代刚粂ē絏癸: "
		Msg07 = "陆亩ア毖叫浪琩 Internet 硈钡陆亩ま篮砞﹚┪琌刚"
		Msg08 = "﹃琌陆亩ま篮ぃや穿匡拒ヘ夹粂ē"
		Msg09 = "========================================="
	Else
		Msg01 = "清空(&C)"
		Msg02 = "读入(&R)"
		Msg05 = "正在翻译，可能需要几分钟，请稍候..."
		Msg06 = "测试的语言代码对为: "
		Msg07 = "翻译失败！请检查 Internet 连接、翻译引擎的设置或是否可访问后再试。"
		Msg08 = "返回的字串为空。可能是翻译引擎不支持选定的目标语言。"
		Msg09 = "========================================="
	End If
...
Function OpenFile(FilePath As String,FileList() As String,x As Integer,Stemp As Boolean) As Boolean
	...
	If OSLanguage = "0404" Then
		...
		Msg03 = "╰参⊿Τ杆 Excel 甅ノ祘Α叫匡ㄤ秨币よ猭"
	...
	Else
		...
		Msg03 = "系统没有安装 Excel 应用程序。请选择其他打开方法。"
...
Sub CheckHelp(HelpTip As String)
	...
	SetUse ="「砞﹚睲虫「" & vbCrLf & _
			...
			"  - 陆亩玡璶蠢传じ" & vbCrLf & _
			"    ﹚竡陆亩玡璶砆蠢传じの蠢传じ" & vbCrLf & vbCrLf & _
			"  - 陆亩璶蠢传じ" & vbCrLf & _
			"    ﹚竡陆亩璶砆蠢传じの蠢传じ" & vbCrLf & vbCrLf & _
			"  》猔種蠢传跋だ糶" & vbCrLf & _
	...
	SetUse ="☆配置列表☆" & vbCrLf & _
			...
			"  - 翻译前要替换的字符" & vbCrLf & _
			"    定义在翻译前要被替换的字符以及替换后的字符。" & vbCrLf & vbCrLf & _
			"  - 翻译后要替换的字符" & vbCrLf & _
			"    定义在翻译后要被替换的字符以及替换后的字符。" & vbCrLf & vbCrLf & _
...
Sub EngineHelp(HelpTip As String)
	...
	Sys = "硁砰セ" & Version & vbCrLf & _
			...
			"甭舦Α禣硁砰" & vbCrLf & _
			"﹛よhttp://www.hanzify.org" & vbCrLf & _
			"秨 祇 簙て穝Θ wanfu (2010)" & vbCrLf & vbCrLf & vbCrLf
	Ement = "「磅︽吏挂「" & vbCrLf & _
			"============" & vbCrLf & _
			"- や穿エ栋矪瞶 Passolo 6.0 のセゲ惠" & vbCrLf & _
			"- Windows Script Host (WSH) ン (VBS)ゲ惠" & vbCrLf & _
			"- Adodb.Stream ンや穿 Utf-8Unicode ゲ惠" & vbCrLf & _
			"- Microsoft.XMLHTTP ンゲ惠" & vbCrLf & _
			"- Microsoft.XMLDOM ン猂 responseXML Α┮惠" & vbCrLf & vbCrLf & vbCrLf
	Dec = "「硁砰虏ざ「" & vbCrLf & _
			"============" & vbCrLf & _
			"Passolo 硈絬陆亩エ栋琌ノ Passolo 陆亩睲虫﹃硈絬陆亩エ栋祘ΑウㄣΤ" & vbCrLf & _
			"- ノ硈絬陆亩ま篮笆陆亩 Passolo 陆亩睲虫い﹃" & vbCrLf & _
			"- 俱ㄇ帝硈絬陆亩ま篮璹ㄤ硈絬陆亩ま篮" & vbCrLf & _
			"- 匡﹃摸铬筁﹃の癸陆亩玡﹃秈︽矪瞶" & vbCrLf & _
			"- 俱獽倍龄沧ゎ才硉竟浪琩エ栋陆亩浪琩タ陆亩い岿粇" & vbCrLf & _
			"- ず竚璹笆穝" & vbCrLf & vbCrLf & _
			"セ祘Α郎" & vbCrLf & _
			"- PSLWebTrans.bas (Passolo 硈絬陆亩エ栋郎 - 癸杠よ遏よΑ磅︽)" & vbCrLf & _
			"- PSLWebTrans_Silent.bas (Passolo 硈絬陆亩エ栋郎 - 繰纐よΑ磅︽)" & vbCrLf & _
			"- PSLWebTrans.txt (虏砰いゅ弧郎)" & vbCrLf & vbCrLf & vbCrLf
	Setup = "「杆よ猭「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 盢秆溃郎狡籹 Passolo ╰参戈Жい﹚竡 Macros 戈Жい" & vbCrLf & _
			"-  Passolo ㄣ -> 璹ㄣ匡虫い穝糤赣エ栋郎﹚竡赣匡虫嘿" & vbCrLf & _
			"  碞翴阑赣匡虫钡㊣" & vbCrLf & _
			"- 繰纐よΑ磅︽硈絬陆亩エ栋度ノ匡拒﹃铬筁﹃㎝﹃矪瞶癸杠よ遏よΑ磅︽" & vbCrLf & _
 			"  硈絬陆亩エ栋砞﹚磅︽璶﹚竡赣エ栋磅︽把计惠ㄏノ癸杠よ遏よΑ砞﹚" & vbCrLf & vbCrLf & vbCrLf
	MainUse = "「陆亩ま篮「" & vbCrLf & _
			"============" & vbCrLf & _
			"祘Α竒矗ㄑㄇ帝硈絬陆亩ま篮眤 [砞﹚] 秙璹砞﹚" & vbCrLf & _
			"穝糤璹砞﹚眤陆亩ま篮睲虫い匡稱ㄏノ陆亩ま篮" & vbCrLf & _
			"Τ闽璹陆亩ま篮叫秨币砞﹚癸杠よ遏翴阑 [弧] 秙把綷弧い弧" & vbCrLf & vbCrLf & _
			"「陆亩ゅ「" & vbCrLf & _
			"============" & vbCrLf & _
			"祘Α笆ヘ玡陆亩睲虫┮妮郎い埃ヘ玡陆亩睲虫ヘ夹粂ē┮Τヘ夹粂ē" & vbCrLf & _
			"硄筁匡ぃ粂ē匡ヘ玡陆亩睲虫いㄓ方﹃┪郎いㄤ陆亩睲虫い" & vbCrLf & _
			"陆亩﹃" & vbCrLf & vbCrLf & _
			"- 匡籔ヘ玡陆亩睲虫ヘ夹粂ē粂ē盢ㄏノヘ玡陆亩睲虫いㄓ方﹃陆亩ゅ" & vbCrLf & _
			"- 匡籔ヘ玡陆亩睲虫ヘ夹粂ēぃ粂ē盢ㄏノ匡拒ㄤ陆亩睲虫い陆亩﹃陆亩" & vbCrLf & _
			"  ゅよ獽盢Τ陆亩锣传Θㄤ粂ēゑ盢虏砰いゅ陆亩Θタ砰いゅ" & vbCrLf & vbCrLf & _
			"「陆亩﹃「" & vbCrLf & _
			"============" & vbCrLf & _
			"矗ㄑ场匡虫癸杠よ遏﹃硉竟セㄤ度匡拒单匡兜" & vbCrLf & vbCrLf & _
			"- 狦匡场玥ㄤ虫兜盢砆笆匡" & vbCrLf & _
			...
			"「铬筁﹃「" & vbCrLf & _
			"============" & vbCrLf & _
			"矗ㄑㄑ狡糵喷靡ゼ陆亩计㎝才腹糶璣ゅ糶璣ゅ单匡兜" & vbCrLf & vbCrLf & _
			"- ┮Τ兜ヘА匡" & vbCrLf & _
			"- 匡糶璣ゅ糶璣ゅ匡兜盢笆匡拒计㎝才腹匡兜计" & vbCrLf & _
			"  ㎝才腹匡兜盢笆跑ぃノ篈" & vbCrLf & vbCrLf & _
			"「﹃矪瞶「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 砞﹚" & vbCrLf & _
			"  祘Α矗ㄑ㎝獽倍龄沧ゎ才硉竟浪琩エ栋箇砞砞﹚赣砞﹚続ノ计薄猵" & vbCrLf & _
			"  眤 [砞﹚] 秙璹砞﹚" & vbCrLf & _
			"  穝糤璹砞﹚眤砞﹚睲虫い匡稱ㄏノ砞﹚" & vbCrLf & _
			"  Τ闽璹砞﹚叫秨币砞﹚癸杠よ遏翴阑 [弧] 秙把綷弧い弧" & vbCrLf & vbCrLf & _
			"- 笆匡砞﹚" & vbCrLf & _
			"  匡拒赣匡兜盢沮砞﹚いノ粂ē睲虫笆匡籔陆亩睲虫ヘ夹粂ē才砞﹚" & vbCrLf & _
			"  》猔種赣匡兜度癸硈絬陆亩エ栋Τ" & vbCrLf & _
			"  璶盢砞﹚籔ヘ玡陆亩睲虫ヘ夹粂ē才 [砞﹚] 秙﹃矪瞶続ノ粂ēい" & vbCrLf & _
			"  穝糤癸莱粂ē" & vbCrLf & _
			"  繰纐よΑ薄猵祘Α盢笆 - 匡 - 箇砞抖匡癸莱砞﹚" & vbCrLf & vbCrLf & _
			"- 埃獽倍龄" & vbCrLf & _
			"  陆亩玡盢﹃い獽倍龄埃獽陆亩ま篮タ絋陆亩" & vbCrLf & vbCrLf & _
			"- 埃硉竟" & vbCrLf & _
			"  陆亩玡盢﹃い硉竟埃獽陆亩ま篮タ絋陆亩" & vbCrLf & vbCrLf & _
			"- 蠢传疭﹚じ陆亩临" & vbCrLf & _
			"  陆亩玡ㄏノ匡拒砞﹚蠢传疭﹚じ陆亩临" & vbCrLf & vbCrLf & _
			"  璶穝糤硂ㄇ疭﹚じ叫砞﹚癸杠よ遏じ蠢传陆亩玡璶蠢传じい﹚竡" & vbCrLf & _
			"  》猔種パエ栋ま篮拜肈Τㄇじ琌ぃ砆块┪礚猭砆侩醚" & vbCrLf & _
			"  狦陆亩ま篮陆亩硂ㄇ蠢传じ砆蠢传じ礚猭砆临" & vbCrLf & vbCrLf & _
			"- だ︽陆亩" & vbCrLf & _
			"  陆亩玡盢︽﹃だ澄虫︽﹃秈︽陆亩獽矗蔼陆亩ま篮陆亩タ絋" & vbCrLf & vbCrLf & _
			"- タ獽倍龄沧ゎ才硉竟" & vbCrLf & _
			"  陆亩ㄏノ匡拒砞﹚浪琩タ陆亩い岿粇" & vbCrLf & _
			"  タよΑ㎝獽倍龄沧ゎ才硉竟浪琩エ栋Ч" & vbCrLf & vbCrLf & _
			"- 蠢传疭﹚じ" & vbCrLf & _
			"  陆亩ㄏノ匡拒砞﹚蠢传陆亩い疭﹚じ" & vbCrLf & vbCrLf & _
			"  璶穝糤硂ㄇ疭﹚じ叫砞﹚癸杠よ遏じ蠢传陆亩璶蠢传じい﹚竡" & vbCrLf & _
			"  》猔種パエ栋ま篮拜肈Τㄇじ琌ぃ砆块┪礚猭砆侩醚" & vbCrLf & _
			"  狦陆亩ま篮陆亩硂ㄇ蠢传玡じ盢礚猭砆蠢传" & vbCrLf & vbCrLf & _
			"「ㄤ匡兜「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 膥尿笆纗┮Τ匡" & vbCrLf & _
			"  匡拒赣兜盢 [膥尿] 秙笆纗┮Τ匡Ω磅︽盢弄纗匡" & vbCrLf & vbCrLf & _
			"- 陪ボ块癟" & vbCrLf & _
			"  匡拒赣兜盢 Passolo 癟块跌怠い块陆亩タ㎝蠢传癟" & vbCrLf & _
			"  ぃ匡拒赣兜薄猵盢陪帝矗蔼祘Α磅︽硉" & vbCrLf & vbCrLf & _
			"- 穝糤陆亩爹秆" & vbCrLf & _
			"  匡拒赣兜盢陆亩睲虫﹃爹秆い糤匡拒陆亩ま篮笆陆亩硂妓爹秆" & vbCrLf & _
			"  ノ赣爹秆跋だ陆亩﹃陆亩矪" & vbCrLf& vbCrLf & _
			"「ㄤ「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 闽" & vbCrLf & _
			"  翴阑赣秙盢闽癸杠よ遏陪ボ祘Αざ残磅︽吏挂秨祇坝の舦单癟" & vbCrLf & vbCrLf & _
			...
			"  翴阑赣秙盢紆ヘ玡跌怠弧癟" & vbCrLf & vbCrLf & _
			"- 砞﹚" & vbCrLf & _
			"  翴阑赣秙盢紆砞﹚癸杠よ遏砞﹚癸杠よ遏い砞﹚贺把计" & vbCrLf & vbCrLf & _
			"- 絋﹚" & vbCrLf & _
			"  翴阑赣秙盢闽超癸杠よ遏匡拒匡兜秈︽﹃陆亩" & vbCrLf & _
			"  》猔種陆亩﹃陆亩篈盢跑狡糵篈ボ跋" & vbCrLf& vbCrLf & _
			"- " & vbCrLf & _
			"  翴阑赣秙盢挡祘Α" & vbCrLf& vbCrLf & vbCrLf
	SetUse ="「砞﹚睲虫「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 匡砞﹚" & vbCrLf & _
			"  璶匡砞﹚兜翴阑砞﹚睲虫" & vbCrLf & vbCrLf & _
			"- 穝糤砞﹚" & vbCrLf & _
			"  璶穝糤砞﹚兜翴阑 [穝糤] 秙紆癸杠よ遏い块嘿" & vbCrLf & vbCrLf & _
			"- 跑砞﹚" & vbCrLf & _
			"  璶跑砞﹚嘿匡砞﹚睲虫い璶э砞﹚礛翴阑 [跑] 秙" & vbCrLf & vbCrLf & _
			"- 埃砞﹚" & vbCrLf & _
			"  璶埃砞﹚兜匡砞﹚睲虫い璶埃砞﹚礛翴阑 [埃] 秙" & vbCrLf & vbCrLf & _
			"穝糤砞﹚盢睲虫い陪ボ穝砞﹚砞﹚ず甧盢陪ボ" & vbCrLf & _
			"跑砞﹚盢睲虫い陪ボэ砞﹚砞﹚ず甧い砞﹚ぃ跑" & vbCrLf & _
			"埃砞﹚盢睲虫い陪ボ砞﹚砞﹚ず甧盢陪ボ砞﹚" & vbCrLf & vbCrLf & _
			"「纗摸「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 郎" & vbCrLf & _
			"  砞﹚盢郎Α纗エ栋┮戈Ж Data 戈Жい" & vbCrLf & vbCrLf & _
			"- 爹" & vbCrLf & _
			"  砞﹚盢砆纗爹い HKCU\Software\VB and VBA Program Settings\WebTranslate 兜" & vbCrLf & vbCrLf & _
			"- 蹲砞﹚" & vbCrLf & _
			"  す砛眖ㄤ砞﹚郎い蹲砞﹚蹲侣砞﹚盢砆笆ど瞷Τ砞﹚睲虫いΤ砞﹚盢" & vbCrLf & _
			"  砆跑⊿Τ砞﹚盢砆穝糤" & vbCrLf & vbCrLf & _
			"- 蹲砞﹚" & vbCrLf & _
			"  す砛蹲┮Τ砞﹚ゅ郎獽ユ传┪锣簿砞﹚" & vbCrLf & vbCrLf & _
			"》猔種ち传纗摸盢笆埃Τ竚い砞﹚ず甧" & vbCrLf & vbCrLf & _
			"「砞﹚ず甧「" & vbCrLf & _
			...
			"<ま篮把计>" & vbCrLf & _
			"  - ㄏノン" & vbCrLf & _
			"    赣ン箇砞Microsoft.XMLHTTPぃ跑" & vbCrLf & _
			"    Τ闽赣ンㄇㄏノよ猭叫把綷闽ゅン" & vbCrLf & vbCrLf & _
			"  - ま篮爹 ID" & vbCrLf & _
			"    Τㄇ陆亩ま篮惠璶爹ㄏノ闽拜肈叫籔陆亩ま篮矗ㄑ坝羛么" & vbCrLf & _
			"    祘Α竒矗ㄑ Microsoft 陆亩ま篮爹 IDぃ玂靡ッㄏノ" & vbCrLf & vbCrLf & _
			"  - ま篮呼" & vbCrLf & _
			"    陆亩ま篮呼" & vbCrLf & _
			"    》猔種砛硈絬陆亩矗ㄑ坝呼ぃ琌痷タ陆亩ま篮呼惠璶だ猂呼絏┪" & vbCrLf & _
			"    高拜痷タ陆亩ま篮矗ㄑ坝眔" & vbCrLf & vbCrLf & _
			"  - 肚癳ず甧絛セ" & vbCrLf & _
			"    赣逆龟悔琌 Microsoft.XMLHTTP  Open よ猭い bstrUrl 把计" & vbCrLf & _
			"    》猔種珹腹 {} いじ╰参逆ぃ跑玥╰参礚猭侩醚" & vbCrLf & _
			"    璶穝糤硂ㄇ╰参逆叫翴阑娩>秙匡惠璶╰参逆" & vbCrLf & vbCrLf & _
			"  - 戈肚癳よΑ" & vbCrLf & _
			"    赣逆龟悔琌 Microsoft.XMLHTTP ン Open よ猭い bstrMethod 把计" & vbCrLf & _
			"     GET ┪ POSTノ POST よΑ肚癳戈, 4MB GET 256KB" & vbCrLf & vbCrLf & _
			"  - ˙よΑ" & vbCrLf & _
			"    赣逆龟悔琌 Microsoft.XMLHTTP ン Open よ猭い varAsync 把计菠" & vbCrLf & _
			"    箇砞 True˙磅︽ DOM い龟琁˙磅︽盢ㄤ砞﹚ False钵˙磅︽" & vbCrLf & vbCrLf & _
			"  - ㄏノ" & vbCrLf & _
			"    赣逆龟悔琌 Microsoft.XMLHTTP ン Open よ猭い bstrUser 把计菠" & vbCrLf & vbCrLf & _
			"  - 盞絏" & vbCrLf & _
			"    赣逆龟悔琌 Microsoft.XMLHTTP ン Open よ猭い bstrPassword 把计菠" & vbCrLf & vbCrLf & _
			"  - 栋" & vbCrLf & _
			"    赣逆龟悔琌 Microsoft.XMLHTTP ン Send よ猭い varBody 把计菠" & vbCrLf & _
			"    ウ琌 XML Α戈琌﹃戈瑈┪礚才腹俱计皚琵硄筁" & vbCrLf & _
			"    Open よ猭い URL 把计" & vbCrLf & vbCrLf & _
			"    肚癳戈よΑだ˙㎝钵˙ㄢ贺" & vbCrLf & _
			"    (1) 钵˙よΑ戈ス肚癳Ч拨碞挡 Send 秈祘め诀磅︽ㄤ巨" & vbCrLf & _
			"    (2) ˙よΑめ诀璶单狝竟絋粄癟挡 Send 秈祘" & vbCrLf & vbCrLf & _
			"  - HTTP 繷㎝" & vbCrLf & _
			"    赣逆龟悔琌 Microsoft.XMLHTTP ンい setRequestHeader よ猭GET よΑ礚" & vbCrLf & _
			"    (1) 赣逆や穿 setRequestHeader 兜ヘ–兜ヘノだ︽だ筳" & vbCrLf & _
			"    (2) –兜ヘ繷嘿 (bstrHeader) ㎝ (bstrValue) ノ硆腹だ筳" & vbCrLf & _
			"    (3) 惠璶肚癳 ContentT-Length 兜ヘㄤㄏノ╰参逆╰参盢笆璸衡ㄤ" & vbCrLf & vbCrLf & _
			"  - 挡狦Α把计" & vbCrLf & _
			"    赣逆龟悔琌 Microsoft.XMLHTTP ンい挡狦Α妮┦Τ碭贺" & vbCrLf & _
			"    responseBody	Variant		挡狦礚才腹俱计皚" & vbCrLf & _
			"    responseStream	Variant		挡狦 ADO Stream ン" & vbCrLf & _
			"    responseText	String		挡狦﹃" & vbCrLf & _
			"    responseXML	Object		挡狦 XML Α戈" & vbCrLf & vbCrLf & _
			"    》猔種讽匡 responseXML 陆亩秨﹍㎝陆亩挡穦だ陪ボ ID 穓" & vbCrLf & _
			"    ㎝夹乓穓" & vbCrLf & vbCrLf & _
			"  - 陆亩秨﹍" & vbCrLf & _
			"    赣逆ノ侩醚挡狦い陆亩﹃玡﹃" & vbCrLf & _
			"    翴阑娩...秙浪跌眖狝竟┮Τゅい莱赣块じ" & vbCrLf & _
			"    》猔種赣逆や穿ノ|だ筳┪兜兜ヘ" & vbCrLf & vbCrLf & _
			"  - 陆亩挡" & vbCrLf & _
			"    赣逆ノ侩醚挡狦い陆亩﹃﹃" & vbCrLf & _
			"    翴阑娩...秙浪跌眖狝竟┮Τゅい莱赣块じ" & vbCrLf & _
			"    》猔種赣逆や穿ノ|だ筳┪兜兜ヘ" & vbCrLf & vbCrLf & _
			"  -  ID 穓" & vbCrLf & _
			"    赣逆ㄏノ XML DOM  getElementById よ猭穓碝 XML 郎いㄣΤ﹚ ID じいゅ" & vbCrLf & _
			"    翴阑娩...秙浪跌眖狝竟┮Τゅい莱赣块 ID 腹" & vbCrLf & _
			"    》猔種赣逆や穿ノ|だ筳┪兜兜ヘ" & vbCrLf & vbCrLf & _
			"  - 夹乓穓" & vbCrLf & _
			"    赣逆ㄏノ XML DOM  getElementsByTagName よ猭穓碝 XML 郎い┮ΤㄣΤ﹚夹乓嘿" & vbCrLf & _
			"    じゅ" & vbCrLf & _
			"    翴阑娩...秙浪跌眖狝竟┮Τゅい莱赣块夹乓嘿" & vbCrLf & _
			"    》猔種赣逆や穿ノ|だ筳┪兜兜ヘ" & vbCrLf & vbCrLf & _
			"<粂ē皌癸>" & vbCrLf & _
			"  - 粂ē嘿" & vbCrLf & _
			"    箇砞粂ē嘿睲虫琌盢 Passolo 粂ē睲虫秈︽弘虏奔瓣產/跋粂ē兜" & vbCrLf & vbCrLf & _
			"  - Passolo 絏" & vbCrLf & _
			"    箇砞粂ē絏 Passolo 粂ē睲虫い ISO 936-1 粂ē絏ㄤい" & vbCrLf & _
			"    虏砰いゅ㎝タ砰いゅ粂ē絏 Passolo 粂ē睲虫い瓣產/跋粂ē絏" & vbCrLf & vbCrLf & _
			"  - 陆亩ま篮絏" & vbCrLf & _
			"    陆亩ま篮┮砏﹚粂ē絏惠璶だ猂呼絏┪高拜陆亩ま篮矗ㄑ坝眔" & vbCrLf & vbCrLf & _
			"  - 糤粂ē" & vbCrLf & _
			"    璶糤粂ē皌癸睲虫兜翴阑 [穝糤] 秙盢紆穝糤癸杠よ遏" & vbCrLf & vbCrLf & _
			"  - 埃粂ē" & vbCrLf & _
			"    璶埃粂ē皌癸睲虫兜匡睲虫い璶埃粂ē礛翴阑 [埃] 秙" & vbCrLf & vbCrLf & _
			"  - 絪胯粂ē" & vbCrLf & _
			"    璶絪胯粂ē皌癸睲虫兜匡睲虫い璶絪胯粂ē礛翴阑 [絪胯] 秙" & vbCrLf & vbCrLf & _
			"  - 场絪胯粂ē" & vbCrLf & _
			"    ㊣ず竚┪场絪胯祘Α絪胯俱粂ē皌癸睲虫" & vbCrLf & vbCrLf & _
			"  - 竚粂ē" & vbCrLf & _
			"    璶盢陆亩ま篮絏竚匡睲虫い璶竚粂ē礛翴阑 [竚] 秙" & vbCrLf & _
			"    [竚] 秙穦沮陆亩ま篮絏琌 (Null) τ陪ボぃノ篈" & vbCrLf & vbCrLf & _
			"  - 砞粂ē" & vbCrLf & _
			"    璶盢陆亩ま篮絏砞﹍匡睲虫い璶砞粂ē礛翴阑 [砞] 秙" & vbCrLf & _
			"    [砞] 秙Τ陆亩ま篮絏砆跑锣ノ篈" & vbCrLf & vbCrLf & _
			"  - 陪ボ獶兜" & vbCrLf & _
			"    璶度陪ボ陆亩ま篮絏獶粂ē兜翴阑 [陪ボ獶兜] 秙翴阑赣秙" & vbCrLf & _
			"    盢锣ぃノ篈[场陪ボ] ㎝ [陪ボ兜] 秙盢锣ノ篈" & vbCrLf & vbCrLf & _
			"  - 陪ボ兜" & vbCrLf & _
			"    璶度陪ボ陆亩ま篮絏 (Null) 粂ē兜翴阑 [陪ボ兜] 秙翴阑" & vbCrLf & _
			"    赣秙盢锣ぃノ篈[场陪ボ] ㎝ [陪ボ獶兜] 秙盢锣ノ篈" & vbCrLf & vbCrLf & _
			"  - 场陪ボ" & vbCrLf & _
			"    璶陪ボ场粂ē兜翴阑 [场陪ボ] 秙翴阑赣秙盢锣ぃノ篈" & vbCrLf & _
			"    [陪ボ獶兜] ㎝ [陪ボ獶兜] 秙盢锣ノ篈" & vbCrLf & vbCrLf & _
			"  穝糤粂ē盢睲虫い陪ボ匡拒穝粂ēの絏癸" & vbCrLf & _
			"  埃粂ē盢睲虫い匡拒┮埃粂ē玡兜粂ē" & vbCrLf & _
			"  絪胯粂ē盢睲虫い陪ボ玂匡拒絪胯粂ēの絏癸" & vbCrLf & _
			"  竚粂ē盢睲虫い陪ボ玂匡拒竚粂ēの絏癸" & vbCrLf & _
			"  砞粂ē盢睲虫い陪ボ玂匡拒砞粂ēの絏癸" & vbCrLf & vbCrLf & _
			"「ㄤ「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 弧" & vbCrLf & _
			"  翴阑赣秙盢紆ヘ玡跌怠弧癟" & vbCrLf & vbCrLf & _
			...
			"  翴阑赣秙ぃ纗砞﹚跌怠いヴ跑挡砞﹚跌怠跌怠" & vbCrLf & _
			"  祘Α盢ㄏノㄓ砞﹚" & vbCrLf & vbCrLf & vbCrLf
	TestUse ="「陆亩ま篮「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 璶代刚陆亩ま篮嘿璶匡陆亩ま篮翴阑陆亩ま篮睲虫" & vbCrLf & vbCrLf & _
			"「ヘ夹粂ē「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 陆亩ヘ夹粂ē赣睲虫度陪ボ粂ē皌癸睲虫い陆亩ま篮粂ē絏ぃ粂ē" & vbCrLf & vbCrLf & _
			"「陆亩睲虫「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 陆亩ゅ陆亩睲虫方赣睲虫盡い┮Τ陆亩睲虫" & vbCrLf & vbCrLf & _
			"「弄︽计「" & vbCrLf & _
			"============" & vbCrLf & _
			"- ﹚眖匡拒陆亩睲虫い弄﹃计" & vbCrLf & vbCrLf & _
			"「陆亩ず甧「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 璶陆亩ゅ匡陆亩睲虫ㄓ方﹃㎝陆亩﹃匡兜笆眖匡拒陆亩睲虫い弄﹃" & vbCrLf & _
			"- 砆弄﹃笆ノ硈钡" & vbCrLf & vbCrLf & _
			"「ㄓ方﹃「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 匡赣匡兜笆眖匡拒陆亩睲虫い弄ㄓ方﹃" & vbCrLf & vbCrLf & _
			"「陆亩﹃「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 匡赣匡兜笆眖匡拒陆亩睲虫い弄陆亩﹃" & vbCrLf & vbCrLf & _
			"「陆亩挡狦「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 眖陆亩ま篮挡狦沮匡拒ㄓ方﹃㎝陆亩﹃匡兜だ陪ボ陆亩ゅ┪眖陆亩ま篮" & vbCrLf & _
			"  场ゅ" & vbCrLf & vbCrLf & _
			"「陆亩ゅ「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 眖陆亩ま篮陆亩赣陆亩琌眖陆亩ま篮场ゅい酚ま篮把计陆亩秨﹍㎝" & vbCrLf & _
			"  陆亩挡逆砞﹚ざぇ丁ゅ" & vbCrLf & vbCrLf & _
			"「场ゅ「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 眖陆亩ま篮场ゅ赣ゅ临珹呼絏ノ赣ゅ笵陆亩秨﹍㎝" & vbCrLf & _
			"  陆亩挡逆莱赣砞﹚" & vbCrLf & vbCrLf & _
			"「ㄤ「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 弧" & vbCrLf & _
			"  翴阑赣秙盢莉弧癟" & vbCrLf & vbCrLf & _
			"- 陆亩" & vbCrLf & _
			"  翴阑赣秙盢酚匡拒兵ン秈︽陆亩" & vbCrLf & vbCrLf & _
			"- 臫莱繷" & vbCrLf & _
			"  翴阑赣秙盢莉 HTTP 臫莱繷罙秆ゅ絪絏单癟" & vbCrLf & vbCrLf & _
			"- 睲" & vbCrLf & _
			"  盢瞷Τ陆亩ず甧㎝陆亩挡狦场睲翴阑盢赣秙盢跑弄篈" & vbCrLf & vbCrLf & _
			"- 弄" & vbCrLf & _
			"  Ω眖匡拒陆亩睲虫い弄﹃翴阑盢赣秙盢跑睲篈" & vbCrLf & vbCrLf & _
			"- " & vbCrLf & _
			"  挡代刚祘Α砞﹚跌怠" & vbCrLf & vbCrLf & vbCrLf
	CopyRight = "「舦「" & vbCrLf & _
			"============" & vbCrLf & _
			"- 硁砰舦耴秨祇㎝э┮Τヴ禣ㄏノэ狡籹床セ硁砰" & vbCrLf & _
			"- э床セ硁砰ゲ斗繦セ弧郎爹硁砰﹍秨祇のэ" & vbCrLf & _
	...
	Thank = "「璓谅「" & vbCrLf & _
			"============" & vbCrLf & _
			"- セ硁砰э筁祘い眔簙て穝穦代刚ボ癑み稰谅" & vbCrLf & vbCrLf & vbCrLf
	Contact = "「籔и羛么「" & vbCrLf & _
			"============" & vbCrLf & _
			"wanfuz_shangyi@163.com" & vbCrLf & vbCrLf & vbCrLf
	Logs = "稰谅や眤や琌и程笆舧ㄏノи籹硁砰" & vbCrLf & vbCrLf & _
	...
	Sys = "软件版本：" & Version & vbCrLf & _
			...
			"授权形式：免费软件" & vbCrLf & _
			"官方主页：http://www.hanzify.org" & vbCrLf & _
			"开 发 者：汉化新世纪成员 wanfu (2010)" & vbCrLf & vbCrLf & vbCrLf
	Ement = "☆运行环境☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 支持宏处理的 Passolo 6.0 及以上版本，必需" & vbCrLf & _
			"- Windows Script Host (WSH) 对象 (VBS)，必需" & vbCrLf & _
			"- Adodb.Stream 对象，支持 Utf-8、Unicode 必需" & vbCrLf & _
			"- Microsoft.XMLHTTP 对象，必需" & vbCrLf & _
			"- Microsoft.XMLDOM 对象，解析 responseXML 返回格式所需" & vbCrLf & vbCrLf & vbCrLf
	Dec = "☆软件简介☆" & vbCrLf & _
			"============" & vbCrLf & _
			"Passolo 在线翻译宏是一个用于 Passolo 翻译列表字串的在线翻译宏程序。它具有以下功能：" & vbCrLf & _
			"- 利用在线翻译引擎自动翻译 Passolo 翻译列表中的字串" & vbCrLf & _
			"- 集成了一些著名的在线翻译引擎，并可自定义其他在线翻译引擎" & vbCrLf & _
			"- 可选择字串类型、跳过字串以及对翻译前后的字串进行处理" & vbCrLf & _
			"- 集成快捷键、终止符、加速器检查宏、可在翻译后检查并纠正翻译中的错误" & vbCrLf & _
			"- 内置可自定义的自动更新功能" & vbCrLf & vbCrLf & _
			"本程序包含下列文件：" & vbCrLf & _
			"- PSLWebTrans.bas (Passolo 在线翻译宏文件 - 对话框方式运行)" & vbCrLf & _
			"- PSLWebTrans_Silent.bas (Passolo 在线翻译宏文件 - 静默方式运行)" & vbCrLf & _
			"- PSLWebTrans.txt (简体中文说明文件)" & vbCrLf & vbCrLf & vbCrLf
	Setup = "☆安装方法☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 将解压后的文件复制到 Passolo 系统文件夹中定义的 Macros 文件夹中" & vbCrLf & _
			"- 在 Passolo 的工具 -> 自定义工具菜单中添加该宏文件并定义该菜单名称，" & vbCrLf & _
			"  此后就可以单击该菜单直接调用" & vbCrLf & _
			"- 静默方式运行的在线翻译宏仅作用于选定字串，跳过字串和字串处理按对话框方式运行" & vbCrLf & _
 			"  的在线翻译宏设置运行。要定义该宏的运行参数，需使用对话框方式设置" & vbCrLf & vbCrLf & vbCrLf
	MainUse = "☆翻译引擎☆" & vbCrLf & _
			"============" & vbCrLf & _
			"程序已经提供一些著名的在线翻译引擎。您也可以按下面的 [设置] 按钮自定义配置。" & vbCrLf & _
			"添加自定义配置后，您可以在翻译引擎列表中选择想使用的翻译引擎。" & vbCrLf & _
			"有关自定义翻译引擎，请打开配置对话框，单击 [帮助] 按钮，参阅帮助中的说明。" & vbCrLf & vbCrLf & _
			"☆翻译源文☆" & vbCrLf & _
			"============" & vbCrLf & _
			"程序自动列出当前翻译列表所属文件中除当前翻译列表的目标语言外的所有目标语言。" & vbCrLf & _
			"通过选择不同的语言，可以选择当前翻译列表中的来源字串，或者同一文件中的其他翻译列表中" & vbCrLf & _
			"的翻译字串。" & vbCrLf & vbCrLf & _
			"- 选择与当前翻译列表目标语言相同的语言时，将使用当前翻译列表中的来源字串作为翻译源文。" & vbCrLf & _
			"- 选择与当前翻译列表目标语言不同的语言时，将使用选定的其他翻译列表中的翻译字串作为翻译" & vbCrLf & _
			"  源文。以方便将已有的翻译转换成其他语言。比如将简体中文翻译成繁体中文。" & vbCrLf & vbCrLf & _
			"☆翻译字串☆" & vbCrLf & _
			"============" & vbCrLf & _
			"提供了全部、菜单、对话框、字符串表、加速器、版本、其他、仅选定等选项。" & vbCrLf & vbCrLf & _
			"- 如果选择全部，则其他单项将被自动取消选择。" & vbCrLf & _
			...
			"☆跳过字串☆" & vbCrLf & _
			"============" & vbCrLf & _
			"提供了供复审、已验证、未翻译、全为数字和符号、全为大写英文、全为小写英文等选项。" & vbCrLf & vbCrLf & _
			"- 所有项目均可以多选。" & vbCrLf & _
			"- 选择全为大写英文、全为小写英文选项时将自动选定全为数字和符号选项，并且全为数字" & vbCrLf & _
			"  和符号选项将自动变为不可用状态。" & vbCrLf & vbCrLf & _
			"☆字串处理☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 配置" & vbCrLf & _
			"  程序提供了和快捷键、终止符、加速器检查宏相同的默认配置，该配置可以适用于大多数情况。" & vbCrLf & _
			"  您也可以按下面的 [设置] 按钮自定义配置。" & vbCrLf & _
			"  添加自定义配置后，您可以在配置列表中选择想使用的配置。" & vbCrLf & _
			"  有关自定义配置，请打开设置对话框，单击 [帮助] 按钮，参阅帮助中的说明。" & vbCrLf & vbCrLf & _
			"- 自动选择配置" & vbCrLf & _
			"  选定该选项时将根据配置中的可用语言列表自动选择与翻译列表目标语言匹配的配置。" & vbCrLf & _
			"  ◎注意：该选项仅对在线翻译宏有效。" & vbCrLf & _
			"  　　　　要将配置与当前翻译列表的目标语言匹配，按 [设置] 按钮，在字串处理的适用语言中" & vbCrLf & _
			"  　　　　添加相应的语言。" & vbCrLf & _
			"  　　　　在静默方式情况下，程序将按“自动 - 自选 - 默认”顺序选择相应的配置。" & vbCrLf & vbCrLf & _
			"- 去除快捷键" & vbCrLf & _
			"  在翻译前将字串中的快捷键删除，以便翻译引擎可以正确翻译。" & vbCrLf & vbCrLf & _
			"- 去除加速器" & vbCrLf & _
			"  在翻译前将字串中的加速器删除，以便翻译引擎可以正确翻译。" & vbCrLf & vbCrLf & _
			"- 替换特定字符并在翻译后还原" & vbCrLf & _
			"  在翻译前使用选定的配置，替换特定字符并在翻译后还原。" & vbCrLf & vbCrLf & _
			"  要添加这些特定字符，请在配置对话框的字符替换的翻译前要替换的字符中定义。" & vbCrLf & _
			"  ◎注意：由于宏引擎的问题，有些字符是不可以被输入或者无法被识别。" & vbCrLf & _
			"  　　　　如果翻译引擎翻译了这些替换后的字符，被替换的字符无法被还原。" & vbCrLf & vbCrLf & _
			"- 分行翻译" & vbCrLf & _
			"  在翻译前将多行的字串拆分为单行字串进行翻译，以便提高翻译引擎翻译的正确度。" & vbCrLf & vbCrLf & _
			"- 纠正快捷键、终止符、加速器" & vbCrLf & _
			"  在翻译后使用选定的配置，检查并纠正翻译中的错误。" & vbCrLf & _
			"  纠正方式和快捷键、终止符、加速器检查宏完全相同。" & vbCrLf & vbCrLf & _
			"- 替换特定字符" & vbCrLf & _
			"  在翻译后使用选定的配置，替换翻译中特定的字符。" & vbCrLf & vbCrLf & _
			"  要添加这些特定字符，请在配置对话框的字符替换的翻译后要替换的字符中定义。" & vbCrLf & _
			"  ◎注意：由于宏引擎的问题，有些字符是不可以被输入或者无法被识别。" & vbCrLf & _
			"  　　　　如果翻译引擎翻译了这些替换前的字符，将无法被替换。" & vbCrLf & vbCrLf & _
			"☆其他选项☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 继续时自动保存所有选择" & vbCrLf & _
			"  选定该项时，将在按 [继续] 按钮时自动保存所有选择，下次运行时将读入保存的选择。" & vbCrLf & vbCrLf & _
			"- 显示输出消息" & vbCrLf & _
			"  选定该项时，将在 Passolo 消息输出窗口中输出翻译、纠正和替换信息。" & vbCrLf & _
			"  在不选定该项情况下，将显著提高程序的运行速度。" & vbCrLf & vbCrLf & _
			"- 添加翻译注释" & vbCrLf & _
			"  选定该项时，将在翻译列表的字串注释中增加选定翻译引擎自动翻译这样的注释。" & vbCrLf & _
			"  利用该注释可以区分翻译字串的翻译出处。" & vbCrLf& vbCrLf & _
			"☆其他功能☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 关于" & vbCrLf & _
			"  单击该按钮，将关于对话框。并显示程序介绍、运行环境、开发商及版权等信息。" & vbCrLf & vbCrLf & _
			...
			"  单击该按钮，将弹出当前窗口的帮助信息。" & vbCrLf & vbCrLf & _
			"- 设置" & vbCrLf & _
			"  单击该按钮，将弹出配置对话框。可以在配置对话框中配置各种参数。" & vbCrLf & vbCrLf & _
			"- 确定" & vbCrLf & _
			"  单击该按钮，将关闭主对话框，并按选定的选项进行字串翻译。" & vbCrLf & _
			"  ◎注意：翻译后的字串翻译状态将更改为待复审状态，以示区别。" & vbCrLf& vbCrLf & _
			"- 取消" & vbCrLf & _
			"  单击该按钮，将退出程序。" & vbCrLf& vbCrLf & vbCrLf
	SetUse ="☆配置列表☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 选择配置" & vbCrLf & _
			"  要选择配置项，单击配置列表。" & vbCrLf & vbCrLf & _
			"- 添加配置" & vbCrLf & _
			"  要添加配置项，单击 [添加] 按钮，在弹出的对话框中输入名称。" & vbCrLf & vbCrLf & _
			"- 更改配置" & vbCrLf & _
			"  要更改配置名称，选择配置列表中要改名的配置，然后单击 [更改] 按钮。" & vbCrLf & vbCrLf & _
			"- 删除配置" & vbCrLf & _
			"  要删除配置项，选择配置列表中要删除的配置，然后单击 [删除] 按钮。" & vbCrLf & vbCrLf & _
			"添加配置后，将在列表中显示新的配置，配置内容将显示空值。" & vbCrLf & _
			"更改配置后，将在列表中显示改名后的配置，配置内容中的配置值不变。" & vbCrLf & _
			"删除配置后，将在列表中显示上一个配置，配置内容将显示上一个配置值。" & vbCrLf & vbCrLf & _
			"☆保存类型☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 文件" & vbCrLf & _
			"  配置将以文件形式保存在宏所在文件夹下的 Data 文件夹中。" & vbCrLf & vbCrLf & _
			"- 注册表" & vbCrLf & _
			"  配置将被保存注册表中的 HKCU\Software\VB and VBA Program Settings\WebTranslate 项下。" & vbCrLf & vbCrLf & _
			"- 导入配置" & vbCrLf & _
			"  允许从其他配置文件中导入配置。导入旧配置时将被自动升级，现有配置列表中已有的配置将" & vbCrLf & _
			"  被更改，没有的配置将被添加。" & vbCrLf & vbCrLf & _
			"- 导出配置" & vbCrLf & _
			"  允许导出所有配置到文本文件，以便可以交换或转移配置。" & vbCrLf & vbCrLf & _
			"◎注意：切换保存类型时，将自动删除原有位置中的配置内容。" & vbCrLf & vbCrLf & _
			"☆配置内容☆" & vbCrLf & _
			...
			"<引擎参数>" & vbCrLf & _
			"  - 使用对象" & vbCrLf & _
			"    该对象默认为“Microsoft.XMLHTTP”，不可更改。" & vbCrLf & _
			"    有关该对象的一些使用方法，请参阅相关文档。" & vbCrLf & vbCrLf & _
			"  - 引擎注册 ID" & vbCrLf & _
			"    有些翻译引擎需要注册才能使用。相关问题请与翻译引擎提供商联系。" & vbCrLf & _
			"    程序已经提供了 Microsoft 翻译引擎的注册 ID。但不保证可以永久使用。" & vbCrLf & vbCrLf & _
			"  - 引擎网址" & vbCrLf & _
			"    翻译引擎的访问网址。" & vbCrLf & _
			"    ◎注意：许多在线翻译提供商的网址并不是真正的翻译引擎访问网址。需要分析网页代码或" & vbCrLf & _
			"    　　　　询问真正的翻译引擎提供商才能取得。" & vbCrLf & vbCrLf & _
			"  - 发送内容模板" & vbCrLf & _
			"    该字段实际上是 Microsoft.XMLHTTP 的 Open 方法中的 bstrUrl 参数。" & vbCrLf & _
			"    ◎注意：大括号 {} 中的字符为系统字段，不可更改，否则系统无法识别。" & vbCrLf & _
			"    　　　　要添加这些系统字段，请单击右边的“>”按钮，选择需要的系统字段。" & vbCrLf & vbCrLf & _
			"  - 数据传送方式" & vbCrLf & _
			"    该字段实际上是 Microsoft.XMLHTTP 对象的 Open 方法中的 bstrMethod 参数。" & vbCrLf & _
			"    即 GET 或 POST。用 POST 方式发送数据,可以大到 4MB，也可以为 GET，只能 256KB。" & vbCrLf & vbCrLf & _
			"  - 同步方式" & vbCrLf & _
			"    该字段实际上是 Microsoft.XMLHTTP 对象的 Open 方法中的 varAsync 参数。可省略。" & vbCrLf & _
			"    缺省为 True，即同步执行，但只能在 DOM 中实施同步执行。一般将其置为 False，即异步执行。" & vbCrLf & vbCrLf & _
			"  - 用户名" & vbCrLf & _
			"    该字段实际上是 Microsoft.XMLHTTP 对象的 Open 方法中的 bstrUser 参数。可省略。" & vbCrLf & vbCrLf & _
			"  - 密码" & vbCrLf & _
			"    该字段实际上是 Microsoft.XMLHTTP 对象的 Open 方法中的 bstrPassword 参数。可省略。" & vbCrLf & vbCrLf & _
			"  - 指令集" & vbCrLf & _
			"    该字段实际上是 Microsoft.XMLHTTP 对象的 Send 方法中的 varBody 参数。可省略。" & vbCrLf & _
			"    它可以是 XML 格式数据，也可以是字符串、流，或者一个无符号整数数组。让指令通过" & vbCrLf & _
			"    Open 方法中的 URL 参数代入。" & vbCrLf & vbCrLf & _
			"    发送数据的方式分为同步和异步两种：" & vbCrLf & _
			"    (1) 异步方式：数据包一旦发送完毕，就结束 Send 进程，客户机执行其他的操作。" & vbCrLf & _
			"    (2) 同步方式：客户机要等到服务器返回确认消息后才结束 Send 进程。" & vbCrLf & vbCrLf & _
			"  - HTTP 头和值" & vbCrLf & _
			"    该字段实际上是 Microsoft.XMLHTTP 对象中的 setRequestHeader 方法，GET 方式下无效。" & vbCrLf & _
			"    (1) 该字段支持多个 setRequestHeader 项目，每个项目用分行分隔。" & vbCrLf & _
			"    (2) 每个项目的头名称 (bstrHeader) 和值 (bstrValue) 用半角逗号分隔。" & vbCrLf & _
			"    (3) 需要发送 ContentT-Length 项目时，其值可以使用系统字段，系统将自动计算其长度。" & vbCrLf & vbCrLf & _
			"  - 返回结果格式参数" & vbCrLf & _
			"    该字段实际上是 Microsoft.XMLHTTP 对象中的一个返回结果格式属性。有以下几种：" & vbCrLf & _
			"    responseBody	Variant	型	结果返回为无符号整数数组" & vbCrLf & _
			"    responseStream	Variant	型	结果返回为 ADO Stream 对象" & vbCrLf & _
			"    responseText	String	型	结果返回为字符串" & vbCrLf & _
			"    responseXML	Object	型	结果返回为 XML 格式数据" & vbCrLf & vbCrLf & _
			"    ◎注意：当选择 responseXML 时，“翻译开始自”和“翻译结束到”会分别显示为“按 ID 搜索”" & vbCrLf & _
			"    　　　　和“按标签名搜索”。" & vbCrLf & vbCrLf & _
			"  - 翻译开始自" & vbCrLf & _
			"    该字段用于识别返回结果中的翻译字串前的字串。" & vbCrLf & _
			"    可单击右边的“...”按钮查看从服务器返回的所有文本中应该输入的字符。" & vbCrLf & _
			"    ◎注意：该字段支持用“|”分隔的多个或项项目。" & vbCrLf & vbCrLf & _
			"  - 翻译结束到" & vbCrLf & _
			"    该字段用于识别返回结果中的翻译字串后的字串。" & vbCrLf & _
			"    可单击右边的“...”按钮查看从服务器返回的所有文本中应该输入的字符。" & vbCrLf & _
			"    ◎注意：该字段支持用“|”分隔的多个或项项目。" & vbCrLf & vbCrLf & _
			"  - 按 ID 搜索" & vbCrLf & _
			"    该字段使用 XML DOM 的 getElementById 方法查找 XML 文件中具有指定 ID 的元素中的文本值。" & vbCrLf & _
			"    可单击右边的“...”按钮查看从服务器返回的所有文本中应该输入的 ID 号。" & vbCrLf & _
			"    ◎注意：该字段支持用“|”分隔的多个或项项目。" & vbCrLf & vbCrLf & _
			"  - 按标签名搜索" & vbCrLf & _
			"    该字段使用 XML DOM 的 getElementsByTagName 方法查找 XML 文件中所有具有指定标签名称的" & vbCrLf & _
			"    元素的文本值。" & vbCrLf & _
			"    可单击右边的“...”按钮查看从服务器返回的所有文本中应该输入的标签名称。" & vbCrLf & _
			"    ◎注意：该字段支持用“|”分隔的多个或项项目。" & vbCrLf & vbCrLf & _
			"<语言配对>" & vbCrLf & _
			"  - 语言名称" & vbCrLf & _
			"    默认的语言名称列表是将 Passolo 的语言列表进行了精简，去掉了国家/地区的语言项。" & vbCrLf & vbCrLf & _
			"  - Passolo 代码" & vbCrLf & _
			"    默认的语言代码取自 Passolo 语言列表中的 ISO 936-1 语言代码。其中：" & vbCrLf & _
			"    简体中文和繁体中文的语言代码取自 Passolo 语言列表中的国家/地区语言代码。" & vbCrLf & vbCrLf & _
			"  - 翻译引擎代码" & vbCrLf & _
			"    翻译引擎所规定的语言代码。需要分析网页代码或询问翻译引擎提供商才能取得。" & vbCrLf & vbCrLf & _
			"  - 增加语言" & vbCrLf & _
			"    要增加语言配对列表项，单击 [添加] 按钮，将弹出添加对话框。" & vbCrLf & vbCrLf & _
			"  - 删除语言" & vbCrLf & _
			"    要删除语言配对列表项，选择列表中要删除的语言，然后单击 [删除] 按钮。" & vbCrLf & vbCrLf & _
			"  - 编辑语言" & vbCrLf & _
			"    要编辑语言配对列表项，选择列表中要编辑的语言，然后单击 [编辑] 按钮。" & vbCrLf & vbCrLf & _
			"  - 外部编辑语言" & vbCrLf & _
			"    调用内置或外部编辑程序编辑整个语言配对列表。" & vbCrLf & vbCrLf & _
			"  - 置空语言" & vbCrLf & _
			"    要将翻译引擎代码置空，选择列表中要置空的语言，然后单击 [置空] 按钮。" & vbCrLf & _
			"    [置空] 按钮会根据翻译引擎代码是否为空 (Null) 而显示不同的可用状态。" & vbCrLf & vbCrLf & _
			"  - 重置语言" & vbCrLf & _
			"    要将翻译引擎代码重置为原始值，选择列表中要重置的语言，然后单击 [重置] 按钮。" & vbCrLf & _
			"    [重置] 按钮只有在翻译引擎代码被更改后才能转为可用状态。" & vbCrLf & vbCrLf & _
			"  - 显示非空项" & vbCrLf & _
			"    要仅显示翻译引擎代码为非空的语言项，单击 [显示非空项] 按钮。单击后该按钮" & vbCrLf & _
			"    将转为不可用状态，[全部显示] 和 [显示空项] 按钮将转为可用状态。" & vbCrLf & vbCrLf & _
			"  - 显示空项" & vbCrLf & _
			"    要仅显示翻译引擎代码为空 (Null) 的语言项，单击 [显示空项] 按钮。单击后" & vbCrLf & _
			"    该按钮将转为不可用状态，[全部显示] 和 [显示非空项] 按钮将转为可用状态。" & vbCrLf & vbCrLf & _
			"  - 全部显示" & vbCrLf & _
			"    要显示全部语言项，单击 [全部显示] 按钮。单击后该按钮将转为不可用状态，" & vbCrLf & _
			"    [显示非空项] 和 [显示非空项] 按钮将转为可用状态。" & vbCrLf & vbCrLf & _
			"  添加语言后，将在列表中显示并选定新的语言及代码对。" & vbCrLf & _
			"  删除语言后，将在列表中选定所删除语言的前一项语言。" & vbCrLf & _
			"  编辑语言后，将在列表中显示并保持选定编辑后的语言及代码对。" & vbCrLf & _
			"  置空语言后，将在列表中显示并保持选定置空后的语言及代码对。" & vbCrLf & _
			"  重置语言后，将在列表中显示并保持选定重置后的语言及代码对。" & vbCrLf & vbCrLf & _
			"☆其他功能☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 帮助" & vbCrLf & _
			"  单击该按钮，将弹出当前窗口的帮助信息。" & vbCrLf & vbCrLf & _
			...
			"  单击该按钮，不保存配置窗口中的任何更改，退出配置窗口并返回主窗口。" & vbCrLf & _
			"  程序将使用原来的配置值。" & vbCrLf & vbCrLf & vbCrLf
	TestUse ="☆翻译引擎☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 要测试的翻译引擎名称。要选择翻译引擎，单击翻译引擎列表。" & vbCrLf & vbCrLf & _
			"☆目标语言☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 翻译的目标语言。该列表仅显示语言配对列表中翻译引擎语言代码不为空的语言。" & vbCrLf & vbCrLf & _
			"☆翻译列表☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 翻译源文的翻译列表源。该列表包含了方案中的所有翻译列表。" & vbCrLf & vbCrLf & _
			"☆读入行数☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 指定从选定翻译列表中读入的字串数。" & vbCrLf & vbCrLf & _
			"☆翻译内容☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 要翻译的文本。选择翻译列表、来源字串和翻译字串选项时自动从选定的翻译列表中读入字串。" & vbCrLf & _
			"- 被读入的字串自动用空格连接。" & vbCrLf & vbCrLf & _
			"☆来源字串☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 选择该选项时，自动从选定的翻译列表中读入来源字串。" & vbCrLf & vbCrLf & _
			"☆翻译字串☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 选择该选项时，自动从选定的翻译列表中读入翻译字串。" & vbCrLf & vbCrLf & _
			"☆翻译结果☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 从翻译引擎返回的结果。根据选定的来源字串和翻译字串选项，分别显示翻译文本或从翻译引擎" & vbCrLf & _
			"  返回的全部文本。" & vbCrLf & vbCrLf & _
			"☆翻译文本☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 从翻译引擎返回的翻译。该翻译是从翻译引擎返回的全部文本中按照引擎参数的“翻译开始自”和" & vbCrLf & _
			"  “翻译结束到”字段的设置，取出介于二者之间的文本。" & vbCrLf & vbCrLf & _
			"☆全部文本☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 从翻译引擎返回的全部文本。该文本可能还包括网页代码。利用该文本可以知道“翻译开始自”和" & vbCrLf & _
			"  “翻译结束到”字段应该如何设置。" & vbCrLf & vbCrLf & _
			"☆其他功能☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 帮助" & vbCrLf & _
			"  单击该按钮，将获取帮助信息。" & vbCrLf & vbCrLf & _
			"- 翻译" & vbCrLf & _
			"  单击该按钮，将按照选定的条件进行翻译。" & vbCrLf & vbCrLf & _
			"- 响应头" & vbCrLf & _
			"  单击该按钮，将获取 HTTP 响应头，以了解文本编码等信息。" & vbCrLf & vbCrLf & _
			"- 清空" & vbCrLf & _
			"  将现有翻译内容和翻译结果全部清空。单击后将该按钮将变为“读入”状态。" & vbCrLf & vbCrLf & _
			"- 读入" & vbCrLf & _
			"  再次从选定的翻译列表中读入字串。单击后将该按钮将变为“清空”状态。" & vbCrLf & vbCrLf & _
			"- 取消" & vbCrLf & _
			"  退出测试程序并返回配置窗口。" & vbCrLf & vbCrLf & vbCrLf
	CopyRight = "☆版权声明☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 此软件的版权归开发者和修改者所有，任何人可以免费使用、修改、复制、散布本软件。" & vbCrLf & _
			"- 修改、散布本软件必须随附本说明文件，并注明软件原始开发者以及修改者。" & vbCrLf & _
	...
	Thank = "☆致　　谢☆" & vbCrLf & _
			"============" & vbCrLf & _
			"- 本软件在修改过程中得到汉化新世纪会员的测试，在此表示衷心的感谢！" & vbCrLf & vbCrLf & vbCrLf
	Contact = "☆与我联系☆" & vbCrLf & _
			"============" & vbCrLf & _
			"wanfu：z_shangyi@163.com" & vbCrLf & vbCrLf & vbCrLf
	Logs = "感谢支持！您的支持是我最大的动力！同时欢迎使用我们制作的软件！" & vbCrLf & vbCrLf & _
